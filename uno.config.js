...
export default defineConfig({
  ...
  shortcuts: [
    ...
    ['f-c-s-c', 'flex justify-center items-start flex-col'],
    ['f-b-s-c', 'flex justify-between items-start flex-col'],
    ['f-c-e-c', 'flex justify-center items-end flex-col'],
    ['f-e-c-c', 'flex justify-evenly items-center flex-col'],
    ['f-a-c-r', 'flex justify-around items-center flex-row'],
    ['f-b-c-r', 'flex justify-between items-center flex-row'],
    ['f-s-c-r', 'flex justify-start items-center flex-row'],
